...
The repository contains the Next.js application shell, local Supabase database foundation, authentication, organization onboarding, project creation and editing, protected project overviews, project-team access management, milestone tracking, and deliverable acceptance. Additional project-management modules are not implemented yet.
